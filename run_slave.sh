...
dmesg -t | grep "[Project2] master" | tee ../output/sample_output_1/dmesg.txt
dmesg -t | grep "[Project2] slave" | tee -a ../output/sample_output_1/dmesg.txt
dmesg -C
...
dmesg -t | grep "[Project2] master" | tee ../output/sample_output_2/dmesg.txt
dmesg -t | grep "[Project2] slave" | tee -a ../output/sample_output_2/dmesg.txt
dmesg -C
...
dmesg -t | grep "[Project2] master" | tee ../output/sample_output_3/dmesg.txt
dmesg -t | grep "[Project2] slave" | tee -a ../output/sample_output_3/dmesg.txt
dmesg -C